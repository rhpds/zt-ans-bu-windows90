...
+
image::1-controller-credentials.png[Cred,link=self]
...
+
image::1-controller-add-machine-credential.png[Add Machine Credential,link=self]
...
+
image::1-gitea-project.png[Proj,link=self]
