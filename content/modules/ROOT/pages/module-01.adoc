...
Select image:create_cred.png[Create] to save
...
Select image:create_proj.png[Save Project] to save
...
preconfigured inventory listed. Click the inventory's name *Workshop Inventory* or the image:edit_inv.png[Edit Inventory] button. 
