...
image::../assets/images/1-controller-credentials.png[Cred]

=== Step 2

Click the image:../assets/images/add.png[Add] icon and add new credential
...
image::../assets/images/1-controller-add-machine-credential.png[Add Machine Credential]

=== Step 4

Select SAVE image:../assets/images/at_save.png[Save]
...
image::../assets/images/1-controller-add-scm-credential.png[Add SCM Credential]
...
image::../assets/images/1-gitea-project.png[Proj]
image::../assets/images/1-gitea-clone.png[Clone]
...
image::../assets/images/1-controller-project.png[Proj]

Click the image:..images/add.png[Add] icon and add new project
...
image::../assets/images/1-controller-create-project.png[Defining a Project]
...
image::../assets/images/1-controller-project-success.png[Succesfull Sync]
...
preconfigured Inventory listed. Click the Inventories' name *Workshop Inventory* or the Edit button. image:../assets/images/at_edit.png[Edit]
...
image::../assets/images/1-controller-edit-inventory.png[Edit Inventory]
...
image::../assets/images/1-controller-hosts-view.png[Hosts View]
...
image::../assets/images/1-controller-group-edit.png[Group Edit]
