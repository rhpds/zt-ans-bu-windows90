...
+
image::6-vscode-existing-folders.png[iis_advanced,link=self]
...
image::6-create-role.png[Role Structure,link=self]
...
image::6-new-site.png[New site.yml,link=self]
...
image::6-job-output.png[Job output,link=self]
