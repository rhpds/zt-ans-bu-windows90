...
2. Create a directory called *iis_basic* and a file called `install_iis.yml`.
...
image::3-vscode-create-folders.png[Empty install_iis.yml,link=self]
...
image::3-vs-auth.png[VS Code AUTH,link=self]
