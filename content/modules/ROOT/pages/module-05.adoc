...
image::../assets/images/5-vscode-existing-folders.png[Student Playbooks]
...
image::../assets/images/5-vscode-create-folders.png[Empty site.yml]
...
----
image::../assets/images/5-vscode-iis-yaml.png[site.yml part 1]
...
----
image::../assets/images/5-vscode-template.png[index.html template]
...
Click SAVE image:../assets/images/at_save.png[Save] and on the following page, select the *Survey* tab.
...
image::../assets/images/5-survey.png[Survey Form]

=== Step 5

Select SAVE image:../assets/images/at_save.png[Add] and remember to flip the *On* switch image:../assets/images/controller_on.png[On switch]
...
Click the rocketship icon image:../assets/images/at_launch_icon.png[Add] for the
