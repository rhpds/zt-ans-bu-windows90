...
Click SAVE image:at_save.png[Save] and on the following page, select the *Survey* tab.
...
Select SAVE image:at_save.png[Add] and remember to flip the *On* switch image:controller_on.png[On switch]
...
Click the rocketship icon image:at_launch_icon.png[Add] for the
