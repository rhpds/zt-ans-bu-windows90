...
image::5-vscode-existing-folders.png[Student Playbooks]
...
image::5-vscode-create-folders.png[Empty site.yml]
...
----
image::5-vscode-iis-yaml.png[site.yml part 1]
...
----
image::5-vscode-template.png[index.html template]
...
image::5-survey.png[Survey Form]
